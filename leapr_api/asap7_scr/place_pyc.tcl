...
puts "=======start pyc place=========="
pyc_reset
pyc_global_placement
pyc_increment_placement U1
place_legal

opt_design -file_prefix place_incr -pre_cts -expanded_scenario -output_file_dir $rpt_dir/place_incr
